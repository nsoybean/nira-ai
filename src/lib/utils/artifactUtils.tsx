...
import { FileMdIcon, FilePptIcon } from "@phosphor-icons/react";
 ...
 */
export function getArtifactIcon(type: string): any {
	const iconMap: Record<string, any> = {
		// slidesOutline: Presentation,
		slidesOutline: <div className="bg-orange-400 rounded-md p-1"> <FilePptIcon size={22} fill="background" /> </div>,
		markdown: <div className="bg-[#10a37f] rounded-md p-1"> <FileMdIcon size={22} fill="background" /></div>,
	};
