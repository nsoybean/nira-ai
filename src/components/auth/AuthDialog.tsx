...
export function AuthDialog({ open, onOpenChange }: AuthDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[360px] p-2 overflow-hidden bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 dark:from-blue-600 dark:via-blue-700 dark:to-blue-900 border-none">
        {/* Decorative bubbles */}
        <div className="absolute top-4 right-12 w-24 h-24 bg-white/20 rounded-full blur-xl" />
        ...
        <div className="relative pt-8 pb-6 px-6 z-10">
          <DialogHeader>
            <DialogTitle className="font-rem text-white text-2xl text-center">
              Welcome to Nira AI
            </DialogTitle>
